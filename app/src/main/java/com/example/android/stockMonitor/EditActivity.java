...
public class EditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSendSMS = (Button)findViewById(R.id.message);
      ...
      mIncreaseButton.setOnClickListener(new View.OnClickListener() {
        ...
        mOrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message = getString(R.string.email_message) +
                        ...
                        "\nQuantity: " + productQuantitytMail +
                        "\nPrice per item expected(ksh): " + productPriceMail +
                        "\nThank you." +
                        "Best regards,";
        ...
        mSendSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = Uri.parse("smsto:0704826011");
                Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
                intent.putExtra("sms_body", "Type your order here");
                startActivity(intent);
            }
        });
