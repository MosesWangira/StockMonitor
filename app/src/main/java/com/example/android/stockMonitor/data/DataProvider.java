package com.example.android.stockMonitor.data;
...
import static com.example.android.stockMonitor.data.DataContract.CONTENT_AUTHORITY;
import static com.example.android.stockMonitor.data.DataContract.PATH_PRODUCTS;
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // This will perform a query on the stock table where the _id equals 2 to return a
